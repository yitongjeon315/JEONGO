...
const siteUrl = process.env.NEXT_PUBLIC_BEFORE_JEONGO_URL ?? 'https://www.aina365.com/before';
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: '/before/og.png', width: 1200, height: 630, alt: 'BEFORE JEONGO 성조 퀘스트' }],
    locale: 'ko_KR',
    type: 'website',
  },
  twitter: {
